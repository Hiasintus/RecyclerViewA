package com.sintus.recyclerviewa;
...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nm = new NegaraModel();
        nm.setNama("Hungary");
        nm.setDeskripsi("negara ini bernama hungaria dalama bahasa indonesia");
        nm.setUrl("https://icons.iconarchive.com/icons/custom-icon-design/all-country-flag/48/Hungary-Flag-icon.png");
        negaraModelList.add(nm);

        nm = new NegaraModel();
        nm.setNama("Slovania");
        nm.setDeskripsi("belum ada deskripsi untuk negara ini silahkan tambah sendiri");
